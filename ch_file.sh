...
docker push caogj/cluster-proportional-autoscaler-amd64:1.1.2
...
docker push caogj/defaultbackend:1.4
...
docker push caogj/elasticsearch:v2.4.1
...
docker push caogj/fluentd-elasticsearch:1.22
...
docker push caogj/k8s-dns-dnsmasq-nanny-amd64:1.14.8
...
docker push caogj/k8s-dns-kube-dns-amd64:1.14.8
...
docker push caogj/kube-registry-proxy:0.4
